const contentLetterSrart_actived = "Hôm nay là một ngày đặc biệt. Và tớ cũng có một món quà nhỏ dành tặng cho cậu(một người quan trọng với tớ)." //Lời mở đầu cho bức thư
const mainContentLetter = " Hi vọng cậu có một ngày sinh thần ý nghĩa luôn vui vẻ ,sống an nhiên.Quãng đời còn lại sẽ tìm được mảnh ghép còn thiếu của đời mình.Tôi Yêu Em<3" //Nội dung của bức thư
